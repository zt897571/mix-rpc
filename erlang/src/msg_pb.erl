...
%% message types
-type test_msg() :: #test_msg{}.

-export_type(['test_msg'/0]).
-type '$msg_name'() :: test_msg.
-type '$msg'() :: test_msg().
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of test_msg -> encode_msg_test_msg(id(Msg, TrUserData), TrUserData) end.
...
decode_msg_2_doit(test_msg, Bin, TrUserData) -> id(decode_msg_test_msg(Bin, TrUserData), TrUserData).
...
verify_msg(Msg, MsgName, Opts) ->
    TrUserData = proplists:get_value(user_data, Opts),
    case MsgName of
        test_msg -> v_msg_test_msg(Msg, [MsgName], TrUserData);
...
get_msg_or_group_names() -> [test_msg].
...
fqbin_to_msg_name(<<"xgame.test_msg">>) -> test_msg;
fqbin_to_msg_name(E) -> error({gpb_error, {badmsg, E}}).


msg_name_to_fqbin(test_msg) -> <<"xgame.test_msg">>;
...
get_msg_containment("msg") -> [test_msg];
